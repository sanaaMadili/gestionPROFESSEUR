   ...
   <div class="container">
       <div class="row">
           <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        <a href="/storage/{{$professeurs->Dossier_scientifique}}" class="link-warning"  download>Download Dossier A</a>
                    </div>
                    @endif
                    <div class="form-group mb-3">
                        <label for="Dossier_scientifique">Dossier A :</label>
                        ...
                        <select name="etat_ds" class="form-select">
                            <option value="En_attente" {{$professeurs->etat_ds=="En_attent" ?'selected' :''}}>En attente</option>
                            <option value="En_cours" {{$professeurs->etat_ds=="En_cour" ?'selected' :''}}>En cours</option>

                            <option value="valide" {{$professeurs->etat_ds=="valid" ?'selected' :''}}>validé</option>
                    ...
                    <div class="form-group mb-3">
                    <a href="/storage/{{$professeurs->Dossier_Pedagogique}}" class="link-warning" download>Download Dossier B</a>
                    </div>
                    @endif
                    <div class="form-group mb-3">
                        <a></a>
                        <label for="Dossier_Pedagogique">Dossier B :</label>
                    ...
                    <div class="form-group mb-3">
                    <a href="/storage/{{$professeurs->Dossier_administratif}}" class="link-warning" download>Download Dossier Dossier C</a>
                    </div>
                    @endif
                    <div class="form-group mb-3">
                        <label for="Dossier_administratif">Dossier C :</label>
